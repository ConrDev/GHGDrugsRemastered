...
public class Menus {
	...
	public static void drugsShop(Player player) {
		...
		cokeMeta.setDisplayName("§c§oHarddrugs");
		...
		weedMeta.setDisplayName("§a§l§oSoftdrugs");
	...
	public static void softDrugs(Player player) {
		Inventory inv = Bukkit.createInventory(null, 36, ChatColor.BOLD + "Drugs Shop | SoftDrugs");
